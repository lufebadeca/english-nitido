...
const MnemonicsPage: React.FC = () => {
  const [selectedTechnique, setSelectedTechnique] = useState(mnemonicTechniques[0]);
  ...
  const nextExample = () => {
    setCurrentExampleIndex((prev) => 
      (prev + 1) % selectedTechnique.examples.length
    );
  };
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      >
        ...
        <p className="text-lg text-gray-600">
          Técnicas de memoria para recordar vocabulario difícil de forma permanente
        </p>
      </motion.div>
      ...
      >
        <h2 className="text-xl font-bold text-purple-800 mb-3">¿Qué son las Mnemotécnias?</h2>
        <p className="text-purple-700 leading-relaxed">
          Las mnemotécnias son técnicas que ayudan a tu cerebro a recordar información de manera más efectiva. 
          Utilizan asociaciones, imágenes mentales y conexiones lógicas para hacer que las palabras en inglés 
      ...
      <motion.div
        ...
        className="space-y-4"
      >
        <h2 className="text-2xl font-bold text-gray-800">Técnicas Disponibles</h2>
          ...
          {mnemonicTechniques.map((technique) => (
            ...
            >
              <div className="flex items-start justify-between mb-2">
                ...
                <span className={`px-2 py-1 rounded-full text-xs font-medium border ${getDifficultyColor(technique.difficulty)}`}>
      ...
      >
        <div className="text-center space-y-6">
          <div className="space-y-2">
            <h2 className="text-2xl font-bold text-purple-800">{selectedTechnique.name}</h2>
            <p className="text-gray-600">{selectedTechnique.description}</p>
            <div className="text-sm text-gray-500">
              Ejemplo {currentExampleIndex + 1} de {selectedTechnique.examples.length}
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6 space-y-4">
            <div className="flex items-center justify-center space-x-4">
              ...
              >
                <Volume2 size={16} />
                <span className="text-2xl font-bold">{currentExample.word}</span>
              </button>
            </div>
          ...
          <div className="bg-yellow-50 rounded-xl border border-yellow-200 p-6 space-y-4">
            <div className="flex items-center justify-center space-x-2 mb-3">
              ...
              <h3 className="text-lg font-bold text-yellow-800">Técnica de Memoria</h3>
            </div>
            
            <div className="text-left space-y-3">
              <div>
                <strong className="text-yellow-800">Método:</strong>
                <p className="text-yellow-700 mt-1">{currentExample.technique}</p>
              </div>
          ...
          {currentExample.visualization && (
            <div className="space-y-3">
              ...
              >
                <Eye size={16} />
                <span>{showVisualization ? 'Ocultar' : 'Ver'} Visualización</span>
              </button>
              ...
              {showVisualization && (
                ...
                >
                  <h4 className="font-bold text-green-800 mb-2">🎨 Imagen Mental:</h4>
                  <p className="text-green-700">{currentExample.visualization}</p>
                </motion.div>
              )}
            </div>
          )}
      ...
      >
        <h3 className="text-lg font-bold text-blue-800 mb-4">🎯 Cómo Usar las Mnemotécnias Efectivamente</h3>
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            <h4 className="font-semibold text-blue-800 mb-2">Pasos para Recordar:</h4>
      ...
      >
        <h3 className="text-lg font-bold text-green-800 mb-3">✨ Crea Tus Propias Mnemotécnias</h3>
        <p className="text-green-700 mb-4">
          Las mnemotécnias más efectivas son las que tú mismo creas. Piensa en palabras en español que 
          suenen similar, situaciones graciosas, o imágenes que te resulten memorables.
        </p>
        <div className="bg-white rounded-lg p-4 border border-green-200">
          <h4 className="font-semibold text-green-800 mb-2">Ejemplo de creación propia:</h4>
          <p className="text-green-700 text-sm">
            <strong>Palabra:</strong> "Embarrassed" (avergonzado)<br/>
            <strong>Tu asociación:</strong> "Suena como 'embarazada' - me da vergüenza estar embarazada"<br/>
