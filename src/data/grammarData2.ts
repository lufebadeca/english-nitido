...
export const basicGrammar2Rules: GrammarRule[] = [
  {
    id: 'to-be-verb',
    title: 'Verbo To Be',
    explanation: ["El verbo to be se usa para expresar acciones habituales, hechos generales y estados, por lo que es ampliamente usado. Es un verbo irregular que no sigue las mismas reglas que otros verbos y su conjugación varía dependiendo del pronombre.",
    "Para la primera persona singular (I), usa 'am'",
    "Para la tercera persona singular (he, she, it) se conjuga 'is'",
    "Para la segunda persona singular (you) y la tercera persona plural (you, we, they) se conjuga 'are'",
    ...
    examples: [
      ...
      },
      {
        ...
        explanation: 'Tercera persona singular negativo - añado "not" tras el verbo'
      }
    ],
    commonMistakes: [
  ...
  },
  {
    id: 'adjectives-1',
    title: 'Adjetivos',
    explanation: ["Los adjetivos son palabras que describen o dan más información sobre un sustantivo.",
    ...
    examples: [
      {
        ...
        explanation: 'Green (verde) es un adjetivo porque describe la cualidad (color) del carro'
      },
      {
        correct: 'My little sister plays with toys',
        translation: 'Mi hermana pequeña juega con juguetes',
        explanation: 'Little (pequeña) es un adjetivo porque describe la cualidad (tamaño/edad) de la hermana'
      },
      {
        ...
        explanation: 'White (blanco) es un adjetivo porque describe la cualidad (color) de las camisetas'
      },
      {
        correct: 'They have really fast bikes',
        translation: 'Tienen bicicletas muy rápidas',
        explanation: 'Fast (rápido) es un adjetivo porque describe la cualidad (velocidad) de las bicicletas'
      },
      {
        correct: 'We are good swimmers',
        translation: 'Somos buenos nadadores',
        explanation: 'Good (bueno) es un adjetivo porque describe la cualidad (habilidad) de los nadadores'
      }
    ],
    commonMistakes: [
  ...
  },
  {
    ...
    explanation: ["Los adverbios son palabras que describen o dan más información sobre un verbo (aunque a veces también sobre un adjetivo u otro adverbio).",
    ...
    examples: [
      {
        ...
        explanation: 'Slowly (lentamente) es un adverbio porque describe la forma (velocidad) de caminar'
      },
      {
        ...
        explanation: 'Well (bien) es un adverbio que describe la forma (velocidad) de hablar.'
      }
    ],
    commonMistakes: [
...
export const grammar2QuizQuestions: QuizQuestion[] = [
  {
    ...
    explanation: 'El verbo to be en presente simple en tercera persona se conjuga "is"',
    points: 10
  },
  {
    id: 'grammar-2',
  ...
  },
  {
    ...
    explanation: 'Los pronombres plurales (you, we, they) usan "are" para el verbo to be',
    points: 10
  },
  {
    id: 'grammar-4',
    ...
    explanation: 'Orden de palabras en inglés: Subject + Verb + Adjective + Object',
    points: 10
  },
  {
    id: 'grammar-5',
    ...
    explanation: 'White es un adjetivo que traduce "blanco", pero en inglés no se usa en plural.',
    points: 15
  },
  {
    id: 'grammar-6',
    ...
    explanation: 'Fast es un adjetivo que traduce "rápido", pero tambien es un adverbio que traduce "rápidamente".',
    points: 15
  },
  {
    id: 'grammar-7',
    ...
    explanation: 'Clearly es un adverbio que traduce "claramente", y por supuesto, va después del verbo.',
    points: 15
  },
];
...
export const grammar2LessonsData: Lesson = {
  ...
  description: 'Aprende las reglas fundamentales de la gramática inglesa nivel 2',
  category: 'grammar',
  difficulty: 2,
  estimatedTime: 40,
  ...
  informativeContent: [
    {
      ...
      content: 'Aprende los patrones mas repetitivos de la gramática es crucial para poder comunicarte en el idioma. El verbo to be es el verbo más importante del inglés, y los adjetivos y adverbios son parte crucial en la mayoria de oraciones.',
      tips: [
